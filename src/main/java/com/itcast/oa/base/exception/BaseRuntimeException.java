...
import com.itcast.oa.base.enums.Separator;
...
public abstract class BaseRuntimeException extends RuntimeException {
    ...
    public String getErrorNo() { 
        return StringUtils.isBlank(errorNo) ? this.toErrorNo() : this.errorNo;
    }

    /**
     * @param errorNo 设置 errorNo 
     */
    ...
    public String toMsg() {
        ...
        for (Error ex : getExceptions()) {
            msg.append(ex.getInfo()).append(Separator.SEMICOLON.value());
        }
    ...
    public String[] packProperties() {
        ...
        return new String[] { "success","errorNo", "msg" };
    }
